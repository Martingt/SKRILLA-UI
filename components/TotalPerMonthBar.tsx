...
export default class CategoryPieChart extends React.Component<any, any>  {
  ...
  render(){
    ...
    console.log(this.state.totalpermonth)
    if(this.state.totalpermonth.lenght > 0){
      ...
      return <div className="content">
        ...
        <div style={{width: 450, height: 350}} className="noChart">
            <img style={{width: 150, height: 150, marginBottom: 10, marginTop: 40}} src="/images/no-bar-series.png"></img>
            <h2>Ups!</h2>
